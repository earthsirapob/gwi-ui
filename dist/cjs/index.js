...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: React__namespace.useContext(ThemeContext$1)
  };
...
const ThemeContext = React.createContext({
    toggleTheme: () => { },
    setTheme: () => { },
    theme: styles$3.createTheme(lightThemeJson), // Default theme
    themeName: 'light',
});
const useTheme = () => React.useContext(ThemeContext);
const ThemeProvider = ({ children }) => {
    const [themeName, setThemeName] = React.useState('light');
    const theme = React.useMemo(() => styles$3.createTheme(themes[themeName]), [themeName]);
    const toggleTheme = () => {
    ...
    return (jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { toggleTheme, setTheme, theme, themeName }, children: jsxRuntimeExports.jsx(styles$3.ThemeProvider, { theme: theme, children: children }) }));
};

exports.Button = MyButton;
exports.Card = Card;
exports.TextField = MyTextField;
