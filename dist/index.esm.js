...
import { Tabs, Tab, createTheme as createTheme$3, ThemeProvider, CssBaseline } from '@mui/material';
...
var MyButton = function (_a) {
    ...
    return (React__default.createElement(Button, { variant: "contained", onClick: onClick }, text));
};

var MyTabs = function (_a) {
    var tabs = _a.tabs, _b = _a.initialTab, initialTab = _b === void 0 ? 0 : _b;
    var _c = React__default.useState(initialTab), selectedTab = _c[0], setSelectedTab = _c[1];
    var handleChange = function (event, newValue) {
        setSelectedTab(newValue);
    };
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Tabs, { value: selectedTab, onChange: handleChange }, tabs.map(function (tab, index) { return (React__default.createElement(Tab, { key: index, label: tab.label })); })),
        React__default.createElement("div", null, tabs[selectedTab].content)));
};

var theme = createTheme$3({
    palette: {
        primary: {
            main: '#1976d2',
        },
...
var MyThemeProvider = function (_a) {
...
export { MyButton, MyTabs, MyThemeProvider };
